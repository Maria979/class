      ...
      ***     MOVE ALL 'Y' TO LAST-OUT.
           MOVE 'MARIA' TO FIRST-OUT.
           MOVE 'CRUZ' TO LAST-OUT.
           MOVE 'MARIASDREAMS' TO CORP-NAME.
           MOVE '.COM' TO SUFFIX.
           MOVE '123456789' TO TEL-NUM.
      *
      *** SUB-STRING EXAMPLES
           DISPLAY 'WEBSITE: ' CORP-NAME(1:12) DOTCOM.
           DISPLAY 'LAST NAME: ' NAME-WS(11:9).
           DISPLAY '(' TEL-NUM(1:3) ')' TEL-NUM(4:2) '-' TEL-NUM(6:4).
      *
      *** CUSTOMER BALANCE NUMERIC CHECK
           MOVE '12345678' TO CUSTOMER-ACCT-BAL-X.
           IF CUSTOMER-ACCT-BAL-X IS NOT NUMERIC DISPLAY "NOT NUMERIC".
